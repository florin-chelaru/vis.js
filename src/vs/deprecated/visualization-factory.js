...
goog.provide('vs.deprecated.VisualizationFactory');
 ...
 * @constructor
 */
vs.deprecated.VisualizationFactory = function(config) {
  /**
 ...
 */
vs.deprecated.VisualizationFactory.prototype.createNew = function($scope, $element, $attrs, taskService) {
 ...
 */
vs.deprecated.VisualizationFactory.prototype.generateOptions = function($scope, $element, $attrs) {
